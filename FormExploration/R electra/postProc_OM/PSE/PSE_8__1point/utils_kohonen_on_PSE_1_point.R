...
plot_traj_representantNode = function(resRepr){
  ...
  plotTrajectorySmart2(times, 1,resRepr$v2_PSE,0, rB,rC,rD,rE,rF,rG,rH,rI, angleH,angleI, angleIni_B,angleIni_D,angleIni_F,lightB,lightC,lightD,lightE,lightF,lightG)  
